...
export const EditWorkspaceForm = ({ onCancel, initialValues }: EditWorkspaceFormProps) => {
    ...
    const [DeleteDialog, confirmDelete] = useConfirm(
        "Tem certeza de que deseja excluir este espaço de trabalho?",
        "Esta ação é irreversível e removerá todos os dados associados.",
        "destructive",
    );

    const [ResetDialog, confirmReset] = useConfirm(
        "Tem certeza de que deseja redefinir o link de convite?",
        "Esta ação é irreversível e invalidará o link de convite atual.",
        "destructive",
    );
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Use o link de convite abaixo para convidar membros para a sua Workspace.
                        </p>
                        <div className="mt-4">
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Excluir uma Workspace é uma ação irreversível e removerá todos os dados associados.
                        </p>
                        <DottedSeparator className="py-7" />
                        <Button
